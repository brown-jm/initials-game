...
## As of 4/24/2021, on Game 355 or 21 weeks
...
```{r}
  ggplot(data = d1, aes(x = OneLetter)) +
    ...
    geom_vline(xintercept = 21, lty = 'dashed') +
    ylab('Probability Density') +
    annotate('text', x = 32, y = 0.05, label = paste0(100*count(d1$OneLetter >= 21) / nrow(d1),'% chance for 21 or more weeks'), color = 'blue') +
